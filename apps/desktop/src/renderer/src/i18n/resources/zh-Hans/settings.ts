export const settings = {
  ...
  general: {
    ...
    revisionAgent: "知识修订 Agent",
    revisionAgentDescription: "选择用于生成待审批知识库变更的 Runtime 与模型。",
    revisionAgentInherit: "继承系统默认",
    revisionAgentPinned: "固定 Runtime 与模型",
    revisionAgentRuntime: "修订 Runtime",
    revisionAgentRuntimeDescription: "仅用于知识库修订任务的 Runtime。",
    revisionAgentModel: "修订模型",
    revisionAgentModelDescription: "用于生成结构化知识库变更的模型。",
