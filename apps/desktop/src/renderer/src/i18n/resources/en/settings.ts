export const settings = {
  ...
  bundleSources: {
    ...
    emptyDescription: "Add a GitHub, GitLab, or generic Git repository to populate the Square.",
    official: "Official",
    enabled: "Enabled",
    refresh: "Refresh",
    remove: "Remove {{name}}",
    ...
    deleteDescription:
      "After deleting {{name}}, its content will no longer appear in the Square. Imported resources are not affected.",
