export const missions = {
  ...
  recoveryActions: "Mission recovery actions",
  ...
  missionPreviewExecutor: "Expert",
  missionPreviewStatus: "Status",
  missionPreviewWorkspace: "Workspace",
  missionPreviewUpdated: "Last updated",
  missionRowAccessibleLabel: "{{title}}, {{status}}",
  ...
  executorConfigurationRequired: "No AI provider is configured, so the conversation cannot start.",
  configureModelSettings: "Set up models",
  configureExpert: "Configure expert",
  homeShortcuts: "Quick selection",
  homeProjects: "Projects",
  homeProjectsEmpty: "Click + to save a setup, then select the project to get started next time.",
  homeProjectsDialogDescription: "Drag to reorder projects.",
  homeProjectManager: "Manage projects",
  homeProjectManagerWithOverflow: "Manage projects ({{count}} more not shown)",
  homeProjectCreate: "New project",
  homeProjectEdit: "Configure project",
  homeProjectEditNamed: "Configure {{name}}",
  homeProjectDragNamed: "Reorder {{name}}",
  homeProjectName: "Project name",
  homeProjectExecutor: "Default executor",
  homeProjectChooseWorkspace: "Choose a workspace or explicitly select the default workspace.",
  homeProjectKnowledgeSelection: "Choose knowledge bases · {{count}} selected",
  homeProjectRemoveUnavailableKnowledge: "Remove {{count}} unavailable knowledge base bindings",
  homeProjectKnowledge: "Knowledge bases",
  homeProjectKnowledgeHint: "Optional. Selected knowledge bases are included in the task.",
  homeProjectDescription: "Save an executor, knowledge bases, and workspace together.",
  homeProjectRequired: "Enter a name and choose valid executor, workspace, and knowledge bindings.",
  homeProjectUnavailable: "Binding unavailable",
  homeProjectRepair: "Some bound resources were deleted. Please update this project.",
  homeProjectDelete: "Delete project",
  homeProjectDeleteDescription:
    "Delete the shortcut setup for “{{name}}”? Existing tasks, resources, and workspace files are kept.",
  homeFavoritesEmpty: "No favorites yet. Use + to add your frequent executors.",
  homeFavorites: "Favorites",
  homeFavoritesHint: "Your experts, teams, and flows",
  homeFavoritesAdd: "Add favorites",
  homeFavoritesManager: "Manage favorites",
  homeFavoritesManagerWithOverflow: "Manage favorites ({{count}} more not shown)",
  homeFavoriteRemoveNamed: "Remove {{name}} from favorites",
  ...
  mentionMembers: "Mention a team member",
  mentionNoMatches: "No matching team members",
  mentionUnavailable: "Unavailable member",
  ...
  expertPreviewStatus: "Current status",
  expertPreviewCallOrder: "Call order",
  expertPreviewTopic: "Conversation topic",
  openExpertWork: "Open expert work view",
