export const missions = {
  ...
  homeProjectsEmpty: "Save your setup. Select a project to get started next time.",
  ...
  homeFavoritesEmpty: "No favorites yet. Use the gear to add your frequent executors.",
