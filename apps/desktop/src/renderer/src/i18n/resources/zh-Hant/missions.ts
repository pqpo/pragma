export const missions = {
  ...
  starting: "正在啟動…",
  startMission: "開始任務",
  constellationReady: "專家已就位",
  constellationOrchestrating: "正在編排專家…",
  constellationRepositoryExpert: "儲存庫分析專家",
  constellationExecutionExpert: "執行專家",
  constellationSynthesisExpert: "綜合專家",
