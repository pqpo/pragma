export const settings = {
  ...
  general: {
    ...
    revisionAgent: "知識修訂 Agent",
    revisionAgentDescription: "選擇用於產生待審批知識庫變更的 Runtime 與模型。",
    revisionAgentInherit: "繼承系統預設",
    revisionAgentPinned: "固定 Runtime 與模型",
    revisionAgentRuntime: "修訂 Runtime",
    revisionAgentRuntimeDescription: "僅用於知識庫修訂任務的 Runtime。",
    revisionAgentModel: "修訂模型",
    revisionAgentModelDescription: "用於產生結構化知識庫變更的模型。",
