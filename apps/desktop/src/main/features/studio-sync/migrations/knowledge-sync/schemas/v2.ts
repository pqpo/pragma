...
export const StoredKnowledgeSyncSummarySchema = z
  .object({
...
export const KnowledgeSyncStateV2Schema = z
  .object({
    ...
    conflicts: z.record(
      ...
      z
        .object({
          ...
          local: StoredKnowledgeSyncSummarySchema,
          remote: StoredKnowledgeSyncSummarySchema,
        })
        .strict(),
    ),
...
export type KnowledgeSyncStateV2 = z.infer<typeof KnowledgeSyncStateV2Schema>;
