...
export interface PragmaDesktopAPI {
  ...
  getContextStoreEditorDraft: (
    input: GetContextStoreEditorDraft,
  ...
  deleteContextStoreRevisionRecord: (input: DeleteContextStoreRevisionRecord) => Promise<void>;
  ...
  recoverMission: (input: MissionExecutionAction) => Promise<Mission>;
  ...
  importSkillRevision: (input: ImportSkillRevision) => Promise<ManagedSkillRevisionJob>;
