...
- Desktop materializes immutable revisions, holds file locks, journals, backs up, republishes, and
...
All historical revisions are upgraded transactionally while retaining their revision numbers, so
