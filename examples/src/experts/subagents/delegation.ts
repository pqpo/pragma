...
const mainAgent = await createExampleExpert(
  ...
  [
    ...
    "When an available Expert is a better match for a focused subtask, use spawn_expert based on the Expert descriptions exposed by that tool. Continue a listed Context only for related follow-up work.",
