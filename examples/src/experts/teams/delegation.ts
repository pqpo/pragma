...
const lead = await createExampleExpert(
  ...
  [
    ...
    "For broad reviews, call spawn_expert once for each independent investigation before calling wait_experts with all returned invocation ids. Use continue_expert only when the work should retain a listed Context.",
