...
import { PragmaEvaluationResourceSchema, type PragmaEvaluationResource } from "./v4-evaluation.ts";
import { z } from "zod";

import { PragmaObjectJsonSchemaSchema } from "./v4-tool-capability.ts";
...
export const PragmaV4SemanticResourceSchema = PragmaResourceSchema;
export const PragmaV4BundleSchema = PragmaBundleSchema;
export const PragmaV4LockSchema = PragmaLockSchema;
