...
const InvocationHandoffV7Schema = z.discriminatedUnion("type", [
...
export const ExecutionRecordV7Schema = z.object({
  ...
  output: InvocationHandoffV7Schema.optional(),
...
export type ExecutionRecordV7 = z.infer<typeof ExecutionRecordV7Schema>;
