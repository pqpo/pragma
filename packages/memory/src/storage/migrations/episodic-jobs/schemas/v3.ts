...
import { EpisodicExtractionJobV2Schema } from "./v2.ts";

export const EpisodicExtractionJobV3Schema = EpisodicExtractionJobV2Schema.omit({
  schemaVersion: true,
  status: true,
}).extend({
  schemaVersion: z.literal("pragma.memory-extraction-job/v3"),
